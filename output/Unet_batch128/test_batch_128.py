...
train_image_dir = 'data/image_data'
...
masks = pd.read_csv('data/ship_segmentations.csv')
...
valid_ids, test_ids = train_test_split(valid_df, 
                 test_size = 0.5, 
                 stratify = valid_df['ships'])
